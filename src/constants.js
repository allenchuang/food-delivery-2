...
export const ACTIVE_ORDERS = [CREATED, COOKED, DRIVER_RECEIVED]
export const INACTIVE_ORDERS = [CANCELLED, DELIVERED]
export const ALL_ORDERS = [...ACTIVE_ORDERS, ...INACTIVE_ORDERS]
